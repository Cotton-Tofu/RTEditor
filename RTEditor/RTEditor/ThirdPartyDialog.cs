...
namespace RTEditor
{
    public partial class ThirdPartyDialog : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        ...
        private void kryptonRichTextBox2_LinkClicked(object sender, LinkClickedEventArgs e)
        {
            Process.Start(e.LinkText);
        }

        private void ThirdPartyDialog_Load(object sender, EventArgs e)
        {
